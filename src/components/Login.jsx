...
function Login() {
    ...
    return(
        <div className="w-screen h-screen grid bg-gray-200 font-rubik">
            <form onSubmit={submitLogin} className="place-self-center flex flex-col items-center rounded-sm border-2 w-10/12 md:w-2/4 h-screen">
                <Link to='/'>
                ...
                <button className="w-full md:w-1/2 h-12 flex flex-row items-center bg-white hover:border-blue-500 hover:text-blue-500 border-2 border-gray-400">
